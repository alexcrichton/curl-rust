...
pub const CURLOPT_DOH_SSL_VERIFYPEER: CURLoption = CURLOPTTYPE_OBJECTPOINT + 306;
pub const CURLOPT_DOH_SSL_VERIFYHOST: CURLoption = CURLOPTTYPE_OBJECTPOINT + 307;
pub const CURLOPT_DOH_SSL_VERIFYSTATUS: CURLoption = CURLOPTTYPE_OBJECTPOINT + 308;
